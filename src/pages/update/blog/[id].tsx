...
export default function UpdateBlog() {
  ...
  const handleUpdate = async () => {
    ...
    await put(newBlog); // Uses PUT method from costom hook
    router.push("/blogs");
  };
  if (loading) {
    return <div className="text-center mt-10">Duke ngarkuar...</div>;
  }
  return (
    <div className="pt-12">
...
UpdateBlog.displayName = "UpdateBlog | My Application";
