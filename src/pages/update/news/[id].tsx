...
export default function UpdateNews() {
    ...
    const handleUpdate = async () => {
        ...
        await put(newNews); // Uses PUT method from custom hook
        router.push("/news");
    };

    if (loading) {
        return <p className="text-center mt-10">Duke ngarkuar...</p>;
    }
...
UpdateNews.displayName = "UpdateNews | My Application";